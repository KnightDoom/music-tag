...
def sanitize_year(year):
    ...
    try:
        ...
        if re.match(r'^[0-9]{4}[-\s][0-9]{1,2}[-\s][0-9]{1,2}$', year):
            year = int(year[:4])
        elif re.match(r'^[0-9]{4}[-\s][0-9]{1,2}$', year):
            year = int(year[:4])
        elif re.match(r'^[0-9]{1,2}[-/\s][0-9]{1,2}[-/\s][0-9]{4}$', year):
            year = int(year[-4:])
        elif re.match(r'^[0-9]{1,2}[-/\s][0-9]{4}$', year):
            year = int(year[-4:])
        else:
...
def sanitize_replaygain_peak(val):
    ...
    ret = math.floor(ret * 1000000) / 1000000
    return ret
