...
class Mp4File(AudioFile):
    ...
    _TAG_MAP = {
        ...
        "totaltracks": TAG_MAP_ENTRY(
            getter=get_totaltracks,
            setter=set_totaltracks,
            remover=rm_totaltracks,
            type=int,
            sanitizer=util.sanitize_int,
        ),
        "discnumber": TAG_MAP_ENTRY(
            getter=get_discnum,
            setter=set_discnum,
            remover=rm_discnum,
            type=int,
        ...
        "totaldiscs": TAG_MAP_ENTRY(
            getter=get_totaldiscs,
        ...
        "year": TAG_MAP_ENTRY(
            getter="©day", setter="©day", type=int, sanitizer=util.sanitize_year
        ),
        "label": TAG_MAP_ENTRY(getter="©pub", setter="©pub", type=str),
        "lyrics": TAG_MAP_ENTRY(getter="©lyr", setter="©lyr", type=str),
        "isrc": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, _MP4_ISRC_KEY),
        ...
        "compilation": TAG_MAP_ENTRY(
            getter="cpil", setter="cpil", type=bool, sanitizer=util.sanitize_bool
        ),
        "artwork": TAG_MAP_ENTRY(
            getter=get_artwork, setter=set_artwork, remover="covr", type=Artwork
        ),
        ...
        "movementtotal": TAG_MAP_ENTRY(
            getter="mvc", setter="mvc", type=int, sanitizer=util.sanitize_int
        ),
        "movement": TAG_MAP_ENTRY(
            getter="mvi", setter="mvi", type=int, sanitizer=util.sanitize_int
        ),
        "conductor": TAG_MAP_ENTRY(getter="@con", setter="@con", type=str),
        "showmovement": TAG_MAP_ENTRY(
            getter="shwm", setter="shwm", type=bool, sanitizer=util.sanitize_bool
        ),
        "key": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:initialkey"),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:initialkey", v
            ),
            remover="----:com.apple.iTunes:initialkey",
            type=str,
        ),
        "media": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:MEDIA"),
            setter=lambda f, k, v: freeform_set(f, "----:com.apple.iTunes:MEDIA", v),
            remover="----:com.apple.iTunes:MEDIA",
            type=str,
        ),
        "musicbrainzartistid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Artist Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Artist Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Artist Id",
            type=str,
        ),
        "musicbrainzdiscid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Disc Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Disc Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Disc Id",
            type=str,
        ),
        "musicbrainzoriginalartistid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Original Artist Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Original Artist Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Original Artist Id",
            type=str,
        ),
        "musicbrainzoriginalalbumid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Original Album Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Original Album Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Original Album Id",
            type=str,
        ),
        "musicbrainzrecordingid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Track Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Track Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Track Id",
            type=str,
        ),
        "musicbrainzalbumartistid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Album Artist Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Album Artist Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Album Artist Id",
            type=str,
        ),
        "musicbrainzreleasegroupid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Release Group Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Release Group Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Release Group Id",
            type=str,
        ),
        "musicbrainzalbumid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Album Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Album Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Album Id",
            type=str,
        ),
        "musicbrainztrackid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Release Track Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Release Track Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Release Track Id",
            type=str,
        ),
        "musicbrainzworkid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:MusicBrainz Work Id"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicBrainz Work Id", v
            ),
            remover="----:com.apple.iTunes:MusicBrainz Work Id",
            type=str,
        ),
        "musicipfingerprint": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:fingerprint"),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:fingerprint", v
            ),
            remover="----:com.apple.iTunes:fingerprint",
            type=str,
        ),
        "musicippuid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:MusicIP PUID"),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:MusicIP PUID", v
            ),
            remover="----:com.apple.iTunes:MusicIP PUID",
            type=str,
        ),
        "acoustidid": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:Acoustid Id"),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:Acoustid Id", v
            ),
            remover="----:com.apple.iTunes:Acoustid Id",
            type=str,
        ),
        "acoustidfingerprint": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:Acoustid Fingerprint"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:Acoustid Fingerprint", v
            ),
            remover="----:com.apple.iTunes:Acoustid Fingerprint",
            type=str,
        ),
        "spotid": TAG_MAP_ENTRY(getter="spot_id", setter="spot_id", type=str),
        "subtitle": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:SUBTITLE"),
            setter=lambda f, k, v: freeform_set(f, "----:com.apple.iTunes:SUBTITLE", v),
            remover="----:com.apple.iTunes:SUBTITLE",
            type=str,
        ),
        "discsubtitle": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(f, "----:com.apple.iTunes:DISCSUBTITLE"),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:DISCSUBTITLE", v
            ),
            remover="----:com.apple.iTunes:DISCSUBTITLE",
            type=str,
        ),
        "replaygaintrackgain": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:ReplayGain Track Gain"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:ReplayGain Track Gain", v
            ),
            remover="----:com.apple.iTunes:ReplayGain Track Gain",
            type=str,
        ),
        "replaygaintrackpeak": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:ReplayGain Track Peak"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:ReplayGain Track Peak", v
            ),
            remover="----:com.apple.iTunes:ReplayGain Track Peak",
            type=str,
        ),
        "replaygainalbumgain": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:ReplayGain Album Gain"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:ReplayGain Album Gain", v
            ),
            remover="----:com.apple.iTunes:ReplayGain Album Gain",
            type=str,
        ),
        "replaygainalbumpeak": TAG_MAP_ENTRY(
            getter=lambda f, k: freeform_get(
                f, "----:com.apple.iTunes:ReplayGain Album Peak"
            ),
            setter=lambda f, k, v: freeform_set(
                f, "----:com.apple.iTunes:ReplayGain Album Peak", v
            ),
    ...
    _TAG_MAP.update(
        {
            ...
            "totaltracks": TAG_MAP_ENTRY(
                getter=util.get_easy_totaltracks,
            ...
            "totaldiscs": TAG_MAP_ENTRY(
                getter=util.get_easy_totaldiscs,
            ...
            "year": TAG_MAP_ENTRY(
                getter="date", setter="date", type=int, sanitizer=util.sanitize_year
            ),
            "compilation": TAG_MAP_ENTRY(
                getter="compilation", setter="compilation", type=bool
            ),
